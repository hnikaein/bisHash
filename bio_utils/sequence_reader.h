...
[[maybe_unused]] std::tuple<std::vector<Sequence>, char *>
read_sequences_from_file(const char *file_name);
...
std::tuple<std::vector<char *>, std::vector<char *>, std::vector<int>, char *>
read_fasta(const char *file_name);
